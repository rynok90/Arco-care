...
import { FOCHI_FEATURES, SITE } from "@/lib/site";

export const Route = createFileRoute("/fochi")({
  head: () => ({
    meta: [
      { title: `Fochi — la app del tutor · ${SITE.name}` },
      {
        name: "description",
        content:
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <ButtonLink to="/contacto" variant="fochi">
