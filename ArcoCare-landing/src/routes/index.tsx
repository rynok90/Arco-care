...
import { CLINIC_SKINS, PAIN, PLANS, SITE, STATS, TESTIMONIALS, TOUR_TEASERS } from "@/lib/site";
    ...
    <>
      ...
      <Section dark>
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <ButtonLink to="/producto" variant="invert" className="mt-6">
          ...
          <div>
            ...
            <ButtonLink to="/fochi" variant="amber" className="mt-6">
          ...
          {TOUR_TEASERS.map((t) => (
            ...
            >
              ...
              <p className="mt-4 inline-flex items-center gap-1 text-sm text-clinic">
                Abrir en el tour <ArrowRight className="size-4 transition-transform group-hover:translate-x-0.5" />
              </p>
            </Link>
          ))}
        </div>
      ...
      <Section>
        ...
        <p className="mt-4 text-center text-sm text-muted">
          <Link to="/precios" className="text-clinic underline-offset-4 hover:underline">
      ...
      <Section dark>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <ButtonLink to="/tour" variant="ghost" className="border-cream/20 text-cream hover:bg-cream/10">
              Ver tour
            </ButtonLink>
          </div>
        </div>
