      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-cream/70">
            <li>
              <Link href="/producto" className="hover:text-cream">
                Arco Care
              </Link>
            </li>
            <li>
              <Link href="/fochi" className="hover:text-cream">
                <FochiWordmark className="text-sm text-inherit" />
              </Link>
            </li>
            <li>
              <Link href="/tour" className="hover:text-cream">
                Tour
              </Link>
            </li>
            <li>
              <Link href="/precios" className="hover:text-cream">
                Precios
              </Link>
            </li>
          </ul>
